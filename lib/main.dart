...
import 'package:random_phrases_redux/ui/favorite_phrase_list_screen.dart';
  ...
  runApp(StoreProvider(
    ...
    child: MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        namedRoutes[Screen.RANDOM_LIST]: (BuildContext context) =>
            RandomPhrasesListScreen(),
        namedRoutes[Screen.FAVORITES]: (BuildContext context) =>
            FavoritePhrasesListScreen(),
      },
    ),
  ));
}
